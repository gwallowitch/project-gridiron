"""Rushing-efficiency feature pipeline."""
...
class RushingFeaturesPipeline(BasePipeline):
    """Build and persist leakage-safe rushing features."""
    ...
    def pipeline_name(self) -> str:
        return "Rushing Features Pipeline"

    @property
    def dataset_name(self) -> str:
        return "rushing_features"
    ...
    def expected_output_path(self) -> Path:
        return (
            ...
            / "curated"
            / "rushing_features"
            / f"rushing_features_{self.season}.parquet"
        )
    ...
    def execute(self) -> PipelineArtifact:
        ...
        features = build_rushing_features(schedule, pbp)

        self.set_stage("feature validation")
        validate_rushing_features(features)
...
def run_rushing_features_pipeline(
    season: int,
    *,
    project_root: Path | str = Path("."),
    database_path: Path | str | None = None,
) -> PipelineRunResult:
    """Run the rushing feature pipeline."""
    return RushingFeaturesPipeline(
        season=season,
