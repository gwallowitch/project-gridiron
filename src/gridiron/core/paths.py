...
class ProjectPaths:
    ...
    @property
    def curated(self) -> Path: return self.data / "curated"
    @property
    def schedules(self) -> Path: return self.raw / "schedules"
    @property
    def play_by_play(self) -> Path: return self.raw / "play_by_play"
    @property
    def rest_features(self) -> Path: return self.curated / "rest_features"
    @property
    def qb_features(self) -> Path: return self.curated / "qb_features"
    @property
    ...
    @property
    def weekly_team_ratings(self) -> Path: return self.curated / "weekly_team_ratings"
    @property
    def strength_of_schedule(self) -> Path: return self.curated / "strength_of_schedule"
    @property
    def pgr(self) -> Path: return self.curated / "pgr"
    @property
    def predictions(self) -> Path: return self.curated / "predictions"
    @property
    def backtests(self) -> Path: return self.curated / "backtests"
    @property
    def reports(self) -> Path: return self.data / "reports"
    @property
    def backtest_reports(self) -> Path: return self.reports / "backtests"
    @property
    def database(self) -> Path: return self.root / "database"
    @property
    def metadata_database(self) -> Path: return self.database / "gridiron.duckdb"
    @property
    ...
    def injury_features_file(self, season: int) -> Path:
        _validate_season(season)
    ...
    def weekly_team_ratings_file(self, season: int) -> Path:
        _validate_season(season)
        return self.weekly_team_ratings / f"weekly_team_ratings_{season}.parquet"

    def strength_of_schedule_file(self, season: int) -> Path:
        _validate_season(season)
        return self.strength_of_schedule / f"strength_of_schedule_{season}.parquet"
